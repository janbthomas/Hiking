...
class MyTableViewController: UITableViewController {
    ...
    var MyHikingList = {
        HikingListObject(hikingLocations: "Point Reyes National Seashore", hikingImages: #imageLiteral(resourceName: "PointReyes"), hikingDetail: "71,000-acre park boasts a visitor center, hiking trails, expansive beaches & panoramic water views.", hikingChecked: false)
